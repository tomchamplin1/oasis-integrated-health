...
export default function Footer() {
  return (
    <footer id="contact" class="p-4 bg-white sm:p-6">
      <div class="md:flex md:justify-between px-4 md:px-16">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            <h2 class="mb-6 text-sm font-semibold text-blue-700 uppercase">
              Navigation
            </h2>
            <ul class="text-gray-600">
              ...
              <li class="mb-4">
                <Link to="/faq" class="hover:underline">
                  FAQ
                </Link>
              </li>
              <li class="mb-4">
      ...
      <div class="sm:flex sm:items-center sm:justify-between px-4 md:px-16">
